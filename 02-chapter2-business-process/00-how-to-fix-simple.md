...
> 🖼️ **วาดตามไม่ถูก อ่านรูปง่ายกว่า?** ดู [`00-use-case-visual-guide.md`](00-use-case-visual-guide.md) — ไฟล์เดียวกันแต่เปิดเป็นรูป (preview ใน VS Code หรือ GitHub ได้เลย) พร้อมเช็คลิสต์เทียบจุดที่เคยวาดพลาด
